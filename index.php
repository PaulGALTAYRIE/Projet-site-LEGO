...
<div class="backgroundBlur"></div>
  <img src="/tai/tai_frog/project/figs/LegoLogo.png" alt="Login Image" id="logo1" width="75" height="75">
    <div class="login">
    ...
    <main>
        ...
        ?>
        <form id="login" method="post" action="/tai/tai_frog/project/Controllers/loginController.php">
