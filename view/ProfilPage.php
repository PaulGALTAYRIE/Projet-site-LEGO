        ...
        <main>
            ...
            <?php
                function afficherCommandes($commandes, $titre, $livreurModel) {
                    if (!empty($commandes)) {
                        foreach ($commandes as $commande) {
                            ...
                            // Ajouter un bouton "Accept" seulement pour les commandes en statut 1
                ...
                if (!empty($commande_0)) {
                    ...
                    echo "<hr>"; // Ligne de séparation après la section "Order in Cart"
                }
                else {
                ...
                if (!empty($commande_1)) {
                    ...
                    echo "<hr>"; // Ligne de séparation après la section "Order in Validation Process"
                }
                else {
                    echo "<div class='empty-message'>";
                ...
                if (!empty($commande_2)) {
                    ...
                    echo "<hr>"; // Ligne de séparation après la section "Order Validated, in Delivery Process"
                }
                else {
                    echo "<div class='empty-message'>";
                ...
                if (!empty($commande_3)) {
                    ...
                    echo "<hr>"; // Ligne de séparation après la section "Delivered Order"
                }
                else {
                    echo "<div class='empty-message'>";
