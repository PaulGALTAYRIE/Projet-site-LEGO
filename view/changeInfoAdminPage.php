...
<body id="ProfilPage">
    ...
    <div class='profil'>
        <main>
            ...
            <?php 
            // Si une variable $something_to_say est définie, affiche un message
            ...
            <form method="post" action="../Controllers/infoUserChangeAdminController.php">
                ...
                <button type="submit" name="change_button_admin" class="change_button_admin">Confirm change</button>
            </form>
            </div>
        </main>
    </div>
