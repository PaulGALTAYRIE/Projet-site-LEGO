...
<body id="ProfilPage">
    ...
    <div class="section">
            <h2>Profil</h2>
            <form method="post" action="../Controllers/infoUserChangeController">
        ...
        <button type="submit" name="change_button" class="change_button" placeholder="change_button">Confirm change</button>
        </form>
    </main>
    <div>
